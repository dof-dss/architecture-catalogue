...
<div class="govuk-grid-row">
    <div class="govuk-grid-column-three-quarters">
        ...
        <p class="govuk-body">
            We collect certain information and data about you when you use the NICS Architecture Catalogue.</p>
        ...
        <p class="govuk-body">
              <strong>Any data you send is at your own risk</strong>.
        </p>
        <p class="govuk-body">
        ...
        <p class="govuk-body">T
            his privacy policy only applies to the NICS Architecture Catalogue, and does not cover other government services and transactions that we link to. These services have their own terms and conditions and privacy policies.
        </p>
        <h3 class="govuk-heading-m">Following a link to another website</h3>
        <p class="govuk-body">
            If you go to another website from this one, read the privacy policy on that website to find out what it does with your information.
        </p>
        <h3 class="govuk-heading-m">Following a link to the NICS Architecture Catalogue from another website</h3>
        <p class="govuk-body">
