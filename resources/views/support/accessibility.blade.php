...
<div class="govuk-grid-row">
    <div class="govuk-grid-column-three-quarters">
        ...
        <p class="govuk-body">
            Parts of this website are not fully accessible. For example some of the functionality requires Javascript to be enabled.
        </p>
        ...
        <p class="govuk-body">
            We are currently assessing this content for compliance with the regulations.
        </p>

        <!-- ## Non compliance with the accessibility regulations -->

        <h2 class="govuk-heading-l">Disproportionate burden</h2>
        <p class="govuk-body">
            Not applicable.
        </p>
        ...
        <!-- ## What we are going to do to improve accessibility -->
    </div>
</div>
